package com.concur.amazonaws.lambda.approval;
...
public class LambdaApprovalFunctionHandler implements RequestHandler<Object, Object> {
	...
	public Object handleRequest(Object input, Context context) {
		...
		dynamoDB = new AmazonDynamoDBClient().withRegion(Region.getRegion(Regions.EU_WEST_1));
		...
		attributeUpdates.put("approval", new AttributeValueUpdate().withValue(new AttributeValue().withS("approved")));
		UpdateItemRequest updateItemRequest = new UpdateItemRequest().withKey(employeeKey)
				.withAttributeUpdates(attributeUpdates).withTableName("lambda-reimbursment");
